...
class ProductController extends Controller
{
    ...
    public function details_product($product_slug, Request $request)
    {
        ...
        $details_product = DB::table('tbl_product')
            ->join('tbl_category_product', 'tbl_category_product.category_id', '=', 'tbl_product.category_id')
            ->join('tbl_brand', 'tbl_brand.brand_id', '=', 'tbl_product.brand_id')
            ->where('tbl_product.product_id', $product_slug)->first();
        ...
        $related_product = DB::table('tbl_product')
            ->join('tbl_category_product', 'tbl_category_product.category_id', '=', 'tbl_product.category_id')
            ->join('tbl_brand', 'tbl_brand.brand_id', '=', 'tbl_product.brand_id')
            ->where('tbl_category_product.category_id', $details_product->category_id)->whereNotIn('tbl_product.product_id', [$product_slug])->orderby(DB::raw('RAND()'))->take(3)->get();
