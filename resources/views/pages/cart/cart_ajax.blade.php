        ...
        <div class="table-responsive cart_info">
            <form action="{{ url('/update-cart') }}" method="POST">
                ...
                <table class="table table-condensed">
                    <thead>
                        <tr class="cart_menu">
                            <td style="width: 50px" class="image">Hình ảnh</td>
                            ...
                            @foreach (Session::get('cart') as $key => $cart)
                                ...
                                <tr>
                                    <td class="cart_product">
                                        <img src="{{ asset('/uploads/product/' . $cart['product_image']) }}" width="90"
                            ...
                            <tr>
                                ...
                                <td>
                                    @if (Session::get('customer_id'))
                                        <a class="btn btn-default check_out" href="{{ url('/checkout') }}">Đặt
                                            hàng</a>
                                    @else
                    ...
                    @else
                        <tr>
                            <td colspan="5">
                                <center>
                                    @php
                                        echo 'Bạn chưa thêm sản phẩm nào <br> Vui lòng thêm sản phẩm vào giỏ hàng';
                                    @endphp
                                </center>
                            </td>
                        </tr>
